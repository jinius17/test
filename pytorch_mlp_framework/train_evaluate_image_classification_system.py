...
if args.block_type == 'conv_block':
    ...
    dim_reduction_block_type = ConvolutionalDimensionalityReductionBlockRes
elif args.block_type == 'norm_block':
    processing_block_type = ConvolutionalProcessingBlockNorm
    dim_reduction_block_type = ConvolutionalDimensionalityReductionBlockNorm
