...
class ConvolutionalProcessingBlockRes(nn.Module):
    ...
    def build_module(self):
        ...
        self.layer_dict['conv_0'].add_module("BN0", nn.BatchNorm2d(num_features=self.num_filters, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True))
...
class ConvolutionalDimensionalityReductionBlockNorm(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation, reduction_factor):
        super(ConvolutionalDimensionalityReductionBlockNorm, self).__init__()
...
class ConvolutionalDimensionalityReductionBlockRes(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation, reduction_factor):
        super(ConvolutionalDimensionalityReductionBlockRes, self).__init__()
