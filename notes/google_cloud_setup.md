...
4. Run ```gcloud config set project s1793292-mlpractical``` where you replace `PROJECT-ID` with your project ID, you can find that in the projects drop down menu on the top of the Google Compute Engine window; this sets the current project as the active one
...
gcloud beta compute --project "s1793292-mlpractical" ssh --zone "us-west1-b" "mlpractical-1"
